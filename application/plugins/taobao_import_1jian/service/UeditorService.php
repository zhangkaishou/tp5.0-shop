...
use app\plugins\taobao_import_1jian\service\Uploader;
...
class UeditorService
{
    ...
    private static function ActionCrawler()
    {
        ...
        $temp_config = array(
            ...
            $temp_config["pathFormat"]=str_replace("images/other","images/goods",$temp_config["pathFormat"]);

     
$allowFiles=$temp_config["allowFiles"];
$allowFiles[]=".mp4";
$temp_config["allowFiles"]=$allowFiles;
